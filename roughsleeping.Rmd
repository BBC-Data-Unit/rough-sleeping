...
Our data includes figures for each year from 2010 to 2015 - but it doesn't include a column telling us how much it changed over that period. This code creates that column based on that calculation:

```{r}
roughsleeping16$change10to15 <- roughsleeping16$`2015.000000` - roughsleeping16$`2010.000000`
```
...
```{r}
roughsleeping16$percchange10to15 <- roughsleeping16$change10to15/roughsleeping16$`2010.000000`
```
